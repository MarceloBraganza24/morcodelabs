...
export default function Hero() {
  return (
    <section className="grid-bg relative min-h-screen overflow-hidden pt-32">
      <div className="absolute left-1/2 top-32 h-72 w-72 -translate-x-1/2 rounded-full bg-cyan-500/20 blur-3xl" />
      <div className="absolute right-10 top-52 h-72 w-72 rounded-full bg-purple-500/10 blur-3xl" />
      ...
      <div className="container-labs relative z-10 flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center text-center">
        ...
        >
          {siteConfig.name} desarrolla landing pages, sistemas web,
          plataformas SaaS, ecommerce, dashboards e integraciones pensadas para
        ...
        >
          <div className="rounded-2xl border border-white/10 bg-slate-950/80 p-5 text-left">
            ...
            <div className="font-mono text-sm leading-7 text-slate-300">
              ...
              <p className="pl-5">
                services: [&quot;SaaS&quot;, &quot;Landing Pages&quot;, &quot;Ecommerce&quot;, &quot;Dashboards&quot;],
              </p>
