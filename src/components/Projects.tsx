        ...
        <SectionReveal>
          <div className="mb-14 max-w-3xl">
            ...
            <h2 className="text-4xl font-semibold tracking-[-0.04em] text-white md:text-6xl">
              Portfolio técnico con enfoque comercial.
            </h2>
            <p className="mt-6 text-lg leading-8 text-slate-400">
              No se trata solo de mostrar pantallas lindas. La idea es mostrar
              sistemas, problemas resueltos, funcionalidades y tecnología real.
            </p>
          </div>
        </SectionReveal>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {projects.map((project, index) => (
            <SectionReveal key={project.title} delay={index * 0.08}>
              <article className="group glass relative min-h-80 overflow-hidden rounded-3xl p-8 transition duration-300 hover:-translate-y-2 hover:border-purple-300/30">
